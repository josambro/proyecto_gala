				...
				<!-- Ingresos -->
					<section id="Ingresos" class="one">
						<div class="container">					
							...
							<header>
								<?php
								$Regresar = "ingresos.php#Clientes";
								include ('funciones.php');
								//uso de la funcion verificar_usuario()
								if (verificar_usuario()){
									//si el usuario es verificado puede acceder al contenido permitido a el
									print "<div class='12u'><a href='ingresos.php#Clientes' class='button scrolly'><span class='icon icon-home'> Regresar</span></a>	";
						...
						<div class="container">						
									...
									isset($_POST['domicilio']) && !empty($_POST['domicilio']) )
							{
							   $con= mysql_connect($host,$user,$pw)or die("<p><h3>Problemas al conectar al servidor</p></h3>");
								...
								mysql_query("INSERT INTO Clientes (nombre,nit,domicilio)VALUES ('$_POST[nombre]','$_POST[nit]','$_POST[domicilio]')",$con);

								echo "<p><h3>DATOS INSERTADOS</p></h3>"; 
								print "<div class='12u'><a href='ingresos.php#Clientes' class='button scrolly'><span class='icon icon-home'> Regresar</span></a>	";
								print "<meta http-equiv=Refresh content=\"2 ; url=ingresos.php#Clientes\">"; 
