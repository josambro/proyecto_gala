	...
	<body>
		...
		<!-- Main -->
			<div id="main">		
				...
				<!-- Ingresos -->
					<section id="Ingresos" class="one">
						<div class="container">					
							...
							<header>
								<?php
								$Regresar = "ingresos.php#Empleados";
				...
				<!-- Empleados-->
					<section id="Empleados" class="three">
						<div class="container">						

							<header>
								<h2 class="alt">Empleados</span></h2>
							</header>
													
							<?php
							include ("conexion.php");
							if(isset($_POST['nombre']) && !empty($_POST['nombre']) &&	
									isset($_POST['dpi']) && !empty($_POST['dpi']) &&	
									...
									isset($_POST['domicilio']) && !empty($_POST['domicilio']) )
							{
							   $con= mysql_connect($host,$user,$pw)or die("<p><h3>Problemas al conectar al servidor</p></h3>");
								...
								mysql_query("INSERT INTO empleados (nombre,domicilio,dpi,puesto)VALUES ('$_POST[nombre]','$_POST[domicilio]','$_POST[dpi]','$_POST[puesto]')",$con);
